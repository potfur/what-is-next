...
class AutoSubmittedChunk<ID, T : Specification.Type, S : Specification<T>, R, D, F>(
    private val delegate: MutableDataChunk<ID, T, S, R, D, F>,
    private val fn: (DataChunk<ID, T, S, R, D, F>, ID, R) -> Result4k<D?, F>
) : MutableDataChunk<ID, T, S, R, D, F> by delegate {
